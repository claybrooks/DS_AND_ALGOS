...
namespace Search
{
    ...
    public:
        ...
        static inline ReturnType Search(
            Container& A
        )
        {
            // Convert to Container::size_type
            return Search(A, A.cbegin(), A.cend() - 1);
        }
        ...
        {
            return Search(A, start - A.cbegin(), end - A.cbegin());
        }

        static ReturnType Search(
            Container& A,
        ...
        )
        {
            ...
            return ReturnType(low, high, max_sum);
        }
